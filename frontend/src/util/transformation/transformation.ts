...
const ARABIC_ORTHOGRAPHIC_RULES = [
  ...
  // Hamza transformations (e.g., ـءَ → ـأَ)
  ...
  // Complex prefix transformations
  ...
  // Names and suffixes
  { pattern: new RegExp(`^عَبدَل$`, "u"), replace: "كَلِأَ" },
  { pattern: new RegExp(`^عَبدِل$`, "u"), replace: "كَلِإِ" },
  { pattern: new RegExp(`^عَبدُل$`, "u"), replace: "كَلِأُ" },
  { pattern: new RegExp(`^عَبدَالءِ$`, "u"), replace: "أَلِإِ" },
  { pattern: new RegExp(`^عَبدَالءُ$`, "u"), replace: "أَلِأُ" },

  // Words with trailing ـ
